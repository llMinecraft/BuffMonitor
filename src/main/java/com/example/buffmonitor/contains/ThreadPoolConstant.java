package com.example.buffmonitor.contains;
...
public class ThreadPoolConstant {
     ...
     *
     */
    public static final Integer SINGLE_CORE_POOL_SIZE = 10;
    public static final Integer SINGLE_MAX_POOL_SIZE = 40;
    public static final Integer SMALL_KEEP_LIVE_TIME = 15;
